# -*- coding: utf-8 -*-
"""
Created on Thu Mar 14 16:46:09 2019
...
factors = ['4. close', 'squared', 'root', 'nasdaq_close', 'squared_nq' , 'root_nq', 'Value', 'squared_oil', 'root_oil', '1 YR', 'squared_tr', 'root_tr']
...
def bootstrappedConfidenceInterval(
   ...
   # t = time.time()
    for i in range(0, numResamples):
        ...
        statslist.append(computeStatisticFunction(resample))
        
    sorted(statslist)
    lowerIndex = int(numResamples * pValue / 2 - 1)
    upperIndex = int(np.ceil(numResamples * (1 - pValue / 2)))
    return (statslist[lowerIndex], statslist[upperIndex])
...
#%%
#factorCov.to_csv('C:/Users/laura/OneDrive/Desktop/DataScience/factorCov.csv')
#factorMeans=pd.DataFrame(factorMeans)
#factorMeans.to_csv('C:/Users/laura/OneDrive/Desktop/DataScience/factorMeans.csv')
#weights=pd.DataFrame(weights)
#weights.to_csv('C:/Users/laura/OneDrive/Desktop/DataScience/weights2.csv')
...
trials=simulateTrialReturns(1000,factorMeans,factorCov, weights)
